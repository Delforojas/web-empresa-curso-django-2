...
class ThreadTestCase(TestCase):
    ...
    def test_add_messages_to_thread(self):
        ...
        message2 = Message.objects.create(user=self.user1, content="Hola")
    ...
    def test_add_message_from_user_not_in_thread(self):
        ...
        message1 = Message.objects.create(user=self.user1, content="Muy Buenas")
        message2 = Message.objects.create(user=self.user1, content="Hola")
        message3 = Message.objects.create(user=self.user3, content="Soy un espiea")
...
#pipenv run python manage.py test messenger.tests.ThreadTestCase.test_add_message_from_user_not_in_thread